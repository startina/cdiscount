...
class CDSApiClient
{
    ...
    protected $password = '';
    protected $urlToken = '';
    public function __construct($username, $password, $urlToken = 'https://sts.cdiscount.com/users/httpIssue.svc/?realm=https://wsvc.cdiscount.com/MarketplaceAPIService.svc') {
    ...
    {
        $token = Token::getInstance()->getToken($this->password, $this->password, $this->urlToken);
        return $token;
    }
